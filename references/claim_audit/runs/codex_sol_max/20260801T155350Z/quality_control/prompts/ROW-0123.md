# Blind second-review task: ROW-0123
...
- This prompt: `quality_control/prompts/ROW-0123.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0123.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0123.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0123/`

Do not write the final `quality_control/results/ROW-0123.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "Na versão de 13 de novembro de 2025 e na especificação com controles de firma e tempo, trabalhadores de 22 a 25 anos em ocupações mais expostas, como desenvolvimento de software e atendimento ao cliente, apresentaram queda relativa de cerca de 16% no emprego.",
...
- row_id: `ROW-0123`
- claim_row_sha256: `19eeb86a68ba10a1efff708f362bbe5737bd0ad4ff09edf0f60e8df03621507c`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0123.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0123`
- `worker_task_name`: `qc_row_0123`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0123.pdf`
