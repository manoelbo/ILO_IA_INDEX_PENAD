# Blind second-review task: ROW-0201
...
- This prompt: `quality_control/prompts/ROW-0201.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0201.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0201.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0201/`

Do not write the final `quality_control/results/ROW-0201.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A redução das vagas não antecede todo e qualquer ajuste no emprego.",
...
- row_id: `ROW-0201`
- claim_row_sha256: `eba8f26c753744f21fa7eb8bf5600321b717871b38b1e747012c3c67f287bdba`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0201.pdf`
