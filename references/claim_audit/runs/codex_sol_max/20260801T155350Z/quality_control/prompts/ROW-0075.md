# Blind second-review task: ROW-0075
...
- This prompt: `quality_control/prompts/ROW-0075.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0075.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0075.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0075/`

Do not write the final `quality_control/results/ROW-0075.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O GPT Exposure utiliza dados sintéticos.",
...
- row_id: `ROW-0075`
- claim_row_sha256: `d61d4ae145471a59c2624f6c5fe5d0d4a28f5c6a096b333cffe73a827b77973a`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0075.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0075`
- `worker_task_name`: `qc_row_0075`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0075.pdf`
