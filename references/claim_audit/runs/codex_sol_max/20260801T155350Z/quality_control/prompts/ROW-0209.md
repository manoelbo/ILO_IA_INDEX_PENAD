# Blind second-review task: ROW-0209
...
- This prompt: `quality_control/prompts/ROW-0209.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0209.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0209.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0209/`

Do not write the final `quality_control/results/ROW-0209.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) encontram uma concentração do efeito entre trabalhadores de 22 a 25 anos.",
  "source_excerpt": "Os resultados brasileiros não reproduzem, nas admissões, a concentração do efeito entre 22 e 25 anos encontrada por Brynjolfsson, Chandar e Chen (2025), que reportam queda de cerca de 12 pontos log para essa coorte.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0209`
- claim_row_sha256: `1154fe608d62a780b5ca9daf3a317aac0271336144f92293af5f4ae4354a73ad`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0209.pdf`
