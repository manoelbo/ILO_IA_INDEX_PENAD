# Blind second-review task: ROW-0025
...
- This prompt: `quality_control/prompts/ROW-0025.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0025.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0025.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0025/`

Do not write the final `quality_control/results/ROW-0025.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0025`
- claim_row_sha256: `2e7a3fc54143f1f65d455c167549b3bc0296f7f1eb9aa28b050b748112c2e66d`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0025.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0025`
- `worker_task_name`: `qc_row_0025`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0025.pdf`
