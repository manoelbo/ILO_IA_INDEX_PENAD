# Blind second-review task: ROW-0208
...
- This prompt: `quality_control/prompts/ROW-0208.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0208.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0208.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0208/`

Do not write the final `quality_control/results/ROW-0208.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "O Painel B, com os contrastes DDD, os diagnósticos de tendências paralelas e as medidas alternativas de saldo, está no apêndice, juntamente com os Painéis A e B da classificação etária adotada por Brynjolfsson, Chandar e Chen (2025).",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0208`
- claim_row_sha256: `b757f1404a908faa444d2598f07661b71e614cee2860dc3e3bd73e652b3044ab`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0208.pdf`
