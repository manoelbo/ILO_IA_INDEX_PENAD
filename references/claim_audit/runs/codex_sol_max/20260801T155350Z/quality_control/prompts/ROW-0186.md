# Blind second-review task: ROW-0186
...
- This prompt: `quality_control/prompts/ROW-0186.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0186.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0186.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0186/`

Do not write the final `quality_control/results/ROW-0186.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "No estudo, ocupações altamente expostas foram afetadas pela pandemia de Covid-19 de maneira distinta.",
...
- row_id: `ROW-0186`
- claim_row_sha256: `5796280c7a6690d3fafa3452ba5e96632284eb36e1741a939957e647a0e787d3`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0186.pdf`
