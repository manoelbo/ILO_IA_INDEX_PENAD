# Blind second-review task: ROW-0049
...
- This prompt: `quality_control/prompts/ROW-0049.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0049.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0049.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0049/`

Do not write the final `quality_control/results/ROW-0049.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0049`
- claim_row_sha256: `235c6bf926a606d72e66be3f7d0053d901b4897cc2f6e6d1d4497602f5fe2120`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0049.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0049`
- `worker_task_name`: `qc_row_0049`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0049.pdf`
