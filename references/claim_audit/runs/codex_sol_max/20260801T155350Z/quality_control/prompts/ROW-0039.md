# Blind second-review task: ROW-0039
...
- This prompt: `quality_control/prompts/ROW-0039.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0039.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0039.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0039/`

Do not write the final `quality_control/results/ROW-0039.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "O GPT Exposure (Eloundou et al., 2023), desenvolvido por OpenAI e Universidade da Pensilvânia, é o trabalho de referência do campo.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0039`
- claim_row_sha256: `d9fff7f0fcde95c0c86c40df315cc77b26678bbc9272108cb6be4750f5fc8770`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0039.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0039`
- `worker_task_name`: `qc_row_0039`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0039.pdf`
