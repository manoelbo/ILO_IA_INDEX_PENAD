# Blind second-review task: ROW-0060
...
- This prompt: `quality_control/prompts/ROW-0060.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0060.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0060.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0060/`

Do not write the final `quality_control/results/ROW-0060.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "O ILO Global Index (Gmyrek et al., 2025), da OIT, é o único estruturado na ISCO-08, a classificação ocupacional internacional da ONU, complementada pela taxonomia polonesa de seis dígitos.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0060`
- claim_row_sha256: `261c4b13f8e20fa237080b1d7ebfc6f995dd75b1aa392ed1ad9fcbfc95eb0a13`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0060.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0060`
- `worker_task_name`: `qc_row_0060`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0060.pdf`
