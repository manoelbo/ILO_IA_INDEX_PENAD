# Blind second-review task: ROW-0171
...
- This prompt: `quality_control/prompts/ROW-0171.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0171.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0171.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0171/`

Do not write the final `quality_control/results/ROW-0171.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Brynjolfsson, Chandar e Chen (2025) mostram que, nos Estados Unidos, a queda relativa de emprego em ocupações expostas é mais intensa entre trabalhadores de 22 a 25 anos.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0171`
- claim_row_sha256: `a31579a277778a036e6e01e828c982bcd422f53c8ce79c422bb18b5e5293d1ef`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0171.pdf`
