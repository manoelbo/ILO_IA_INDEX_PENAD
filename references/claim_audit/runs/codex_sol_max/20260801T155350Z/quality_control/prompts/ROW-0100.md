# Blind second-review task: ROW-0100
...
- This prompt: `quality_control/prompts/ROW-0100.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0100.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0100.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0100/`

Do not write the final `quality_control/results/ROW-0100.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0100`
- claim_row_sha256: `ce44e967edbd927b1beeae3817c08a1570351d6e21c0db758378fea29794a58b`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0100.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0100`
- `worker_task_name`: `qc_row_0100`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0100.pdf`
