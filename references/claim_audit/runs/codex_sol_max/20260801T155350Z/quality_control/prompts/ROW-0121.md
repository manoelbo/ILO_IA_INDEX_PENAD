# Blind second-review task: ROW-0121
...
- This prompt: `quality_control/prompts/ROW-0121.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0121.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0121.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0121/`

Do not write the final `quality_control/results/ROW-0121.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A granularidade dos dados e o desenho permitem detectar ajustes por ocupação e idade logo após o lançamento do ChatGPT.",
  "source_excerpt": "A unidade da estimação, porém, não é o vínculo: os autores agregam o emprego em células de firma por quintil de exposição por mês e estimam uma regressão de Poisson com efeitos fixos de firma por quintil e de firma por tempo (Brynjolfsson, Chandar e Chen, 2025, p. 15). Essa granularidade, combinada a esse desenho, permitiu detectar ajustes finos por ocupação e por idade logo após o lançamento do ChatGPT.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0121`
- claim_row_sha256: `51de24f1cdefe4277ce88138304c44363a056081bfb62c5370bc1f6f40fc1c3f`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0121.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0121`
- `worker_task_name`: `qc_row_0121`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0121.pdf`
