# Blind second-review task: ROW-0191
...
- This prompt: `quality_control/prompts/ROW-0191.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0191.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0191.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0191/`

Do not write the final `quality_control/results/ROW-0191.json`; the QC controller validates and commits it atomically.
...
- `source_sha256`: `43b8b1867d44fec8e557eea0001f73db5394ab2a05cef2bafbf2d74d3c9c9eba`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0191.pdf`
