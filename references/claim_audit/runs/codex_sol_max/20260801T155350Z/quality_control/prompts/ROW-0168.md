# Blind second-review task: ROW-0168
...
- This prompt: `quality_control/prompts/ROW-0168.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0168.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0168.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0168/`

Do not write the final `quality_control/results/ROW-0168.json`; the QC controller validates and commits it atomically.
...
- `source_sha256`: `7b0fd0da42bcf424158222c2cddc0fadf24634d907b7ce0865004f918e5ddd57`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0168.pdf`
