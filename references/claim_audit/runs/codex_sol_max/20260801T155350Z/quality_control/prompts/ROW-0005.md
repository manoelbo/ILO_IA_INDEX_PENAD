# Blind second-review task: ROW-0005
...
- This prompt: `quality_control/prompts/ROW-0005.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0005.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0005.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0005/`

Do not write the final `quality_control/results/ROW-0005.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "De um lado, consolidou-se uma metodologia de construção de índices de exposição baseados em tarefas, a partir do GPT Exposure de Eloundou et al. (2023), que passou a usar os próprios LLMs como avaliadores das tarefas.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0005`
- claim_row_sha256: `337ed5751330ecdeceb8da082be7d89b273682d200ca835330001f9e3f86eee7`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0005.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0005.pdf`
