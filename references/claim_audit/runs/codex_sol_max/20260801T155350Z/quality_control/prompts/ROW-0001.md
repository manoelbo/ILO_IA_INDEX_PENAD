# Blind second-review task: ROW-0001
...
- This prompt: `quality_control/prompts/ROW-0001.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0001.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0001.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0001/`

Do not write the final `quality_control/results/ROW-0001.json`; the QC controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0001.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `852097fc72812af45bd3693d7a661c70457eb674ab8f493cadb268450e556b5b`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0001.pdf`
