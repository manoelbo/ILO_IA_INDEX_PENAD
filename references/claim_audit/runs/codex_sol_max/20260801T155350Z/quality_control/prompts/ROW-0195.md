# Blind second-review task: ROW-0195
...
- This prompt: `quality_control/prompts/ROW-0195.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0195.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0195.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0195/`

Do not write the final `quality_control/results/ROW-0195.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A contração do emprego em firmas que adotam IA decorre sobretudo da desaceleração das contratações.",
...
- row_id: `ROW-0195`
- claim_row_sha256: `bec141519d9ef632c0146797eb6dd3ea549d9c50202d1396d0dc761deb2c58bd`
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0195.pdf`
