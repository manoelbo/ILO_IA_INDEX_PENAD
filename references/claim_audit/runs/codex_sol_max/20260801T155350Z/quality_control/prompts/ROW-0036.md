# Blind second-review task: ROW-0036
...
- This prompt: `quality_control/prompts/ROW-0036.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0036.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0036.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0036/`

Do not write the final `quality_control/results/ROW-0036.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Diagnósticos feitos por IA foram iguais ou tão precisos quanto os de dois terços dos médicos americanos (Agarwal et al., 2023). Mas o diagnóstico é apenas uma das muitas tarefas da profissão, que também envolve coordenação de equipe, comunicação com outros médicos e interação com pacientes.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0036`
- claim_row_sha256: `d40526a8a92e828d93ec8a821c8f1c598b082fab353ff6fc2b8f99f486ccc132`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0036.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0036`
- `worker_task_name`: `qc_row_0036`
...
- `source_sha256`: `7e3c307db768df2d4e4d1b31247229e75fb3e819015ff3d7344539edd7600e74`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0036.pdf`
