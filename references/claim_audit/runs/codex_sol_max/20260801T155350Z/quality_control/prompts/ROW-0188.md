# Blind second-review task: ROW-0188
...
- This prompt: `quality_control/prompts/ROW-0188.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0188.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0188.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0188/`

Do not write the final `quality_control/results/ROW-0188.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Humlum e Vestergaard (2025) utilizam dados administrativos da Dinamarca.",
...
- row_id: `ROW-0188`
- claim_row_sha256: `395a490d5e6764d69556e03c74f36f9d4783d17d879d3db3dc8ea8ec1c084336`
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0188.pdf`
