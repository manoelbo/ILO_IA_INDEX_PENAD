# Blind second-review task: ROW-0002
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0002`
...
- This prompt: `quality_control/prompts/ROW-0002.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0002.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0002.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0002/`

Do not write the final `quality_control/results/ROW-0002.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0002`
- claim_row_sha256: `8264f3b03ac66f1b66d0cfcbee4e4706e60a5e029c63726c8104f199250d46f0`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0002.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0002`
- `worker_task_name`: `retry1_qc_row_0002`
...
- `source_sha256`: `852097fc72812af45bd3693d7a661c70457eb674ab8f493cadb268450e556b5b`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0002.pdf`
