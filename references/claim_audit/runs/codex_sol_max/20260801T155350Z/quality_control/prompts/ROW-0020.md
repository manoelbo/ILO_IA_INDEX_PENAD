# Blind second-review task: ROW-0020
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0020`
...
- This prompt: `quality_control/prompts/ROW-0020.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0020.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0020.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0020/`

Do not write the final `quality_control/results/ROW-0020.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0020`
- claim_row_sha256: `d3209ad17b0638fe93996483eaa7d7cde87ff4ddf78041013b98957b031a3078`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0020.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0020`
- `worker_task_name`: `retry1_qc_row_0020`
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0020.pdf`
