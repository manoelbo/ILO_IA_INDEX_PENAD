# Blind second-review task: ROW-0158
...
- This prompt: `quality_control/prompts/ROW-0158.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0158.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0158.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0158/`

Do not write the final `quality_control/results/ROW-0158.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0158`
- claim_row_sha256: `0c90be49eaf0bc6325d030dea10300c82ed7e9029e80c5c76c3bd7c211a6860d`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0158.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0158`
- `worker_task_name`: `qc_row_0158`
...
- `source_sha256`: `4f877146cba18f2d19781e2e5ea0be9275d698ef1295f166f7d1778bfc1e17fc`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0158.pdf`
