# Blind second-review task: ROW-0162
...
- This prompt: `quality_control/prompts/ROW-0162.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0162.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0162.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0162/`

Do not write the final `quality_control/results/ROW-0162.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Estudos de evento centrados em novembro de 2022 tornaram-se comuns na literatura.",
...
- row_id: `ROW-0162`
- claim_row_sha256: `16aba392b9ce257934872d4097b62eb2c93b38a8cd5c46ff3e69c18d7e1ddf30`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0162.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0162`
- `worker_task_name`: `qc_row_0162`
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0162.pdf`
