# Blind second-review task: ROW-0187
...
- This prompt: `quality_control/prompts/ROW-0187.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0187.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0187.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0187/`

Do not write the final `quality_control/results/ROW-0187.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O efeito diferencial da pandemia sobre ocupações altamente expostas contamina a linha de base anterior ao ChatGPT.",
...
- row_id: `ROW-0187`
- claim_row_sha256: `399e7aa2293ae6a0538e9fbf3fb35bc8ec98d2586fde7fc8e9b50a7f67a11fed`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0187.pdf`
