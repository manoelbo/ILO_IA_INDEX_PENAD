# Blind second-review task: ROW-0031
...
- This prompt: `quality_control/prompts/ROW-0031.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0031.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0031.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0031/`

Do not write the final `quality_control/results/ROW-0031.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A abordagem de Brynjolfsson, Chandar e Chen (2025) fundamenta o uso do lançamento do ChatGPT como evento empírico.",
...
- row_id: `ROW-0031`
- claim_row_sha256: `48dbd0898ea589ac22585e27fc5d5d1bfc413afbc821f002f14645654b6b0d94`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0031.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0031`
- `worker_task_name`: `qc_row_0031`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0031.pdf`
