# Blind second-review task: ROW-0189
...
- This prompt: `quality_control/prompts/ROW-0189.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0189.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0189.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0189/`

Do not write the final `quality_control/results/ROW-0189.json`; the QC controller validates and commits it atomically.
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0189.pdf`
