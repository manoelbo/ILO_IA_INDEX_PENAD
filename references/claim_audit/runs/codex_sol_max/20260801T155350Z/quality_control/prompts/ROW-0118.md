# Blind second-review task: ROW-0118
...
- This prompt: `quality_control/prompts/ROW-0118.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0118.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0118.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0118/`

Do not write the final `quality_control/results/ROW-0118.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0118`
- claim_row_sha256: `3eed05357aaba27c583cb8435bccdabc3691f8c0e2e29bdb70c955f889a621fe`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0118.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0118`
- `worker_task_name`: `qc_row_0118`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0118.pdf`
