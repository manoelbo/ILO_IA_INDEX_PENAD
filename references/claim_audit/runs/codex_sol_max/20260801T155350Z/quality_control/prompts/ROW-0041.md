# Blind second-review task: ROW-0041
...
- This prompt: `quality_control/prompts/ROW-0041.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0041.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0041.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0041/`

Do not write the final `quality_control/results/ROW-0041.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0041`
- claim_row_sha256: `91e2358b5161511ec41ae83a42dbe69e34cd1b0a112aafb033e9b56c90f1faea`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0041.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0041`
- `worker_task_name`: `qc_row_0041`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0041.pdf`
