# Blind second-review task: ROW-0010
...
- This prompt: `quality_control/prompts/ROW-0010.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0010.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0010.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0010/`

Do not write the final `quality_control/results/ROW-0010.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Recém-formados em ocupações expostas à IA estão recebendo salários menores.",
...
- row_id: `ROW-0010`
- claim_row_sha256: `23c32d65bbb849f629b172b8754544407cf222e873c401e87808739e2c8a0755`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0010.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0010.pdf`
