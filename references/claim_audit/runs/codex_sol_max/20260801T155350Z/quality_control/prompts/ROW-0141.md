# Blind second-review task: ROW-0141
...
- This prompt: `quality_control/prompts/ROW-0141.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0141.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0141.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0141/`

Do not write the final `quality_control/results/ROW-0141.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0141`
- claim_row_sha256: `ec6e378318fd425ba3f4fab6a1ed64addf45d80eca1c1bf408f23cff97736588`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0141.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0141`
- `worker_task_name`: `qc_row_0141`
...
- `source_sha256`: `ddc65e7599d8364181fd84d388ec543d57bfa51c2e66d50777af7ebac2aba3c4`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0141.pdf`
