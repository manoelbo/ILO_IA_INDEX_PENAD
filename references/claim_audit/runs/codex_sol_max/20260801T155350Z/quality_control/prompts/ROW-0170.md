# Blind second-review task: ROW-0170
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0170`
...
- This prompt: `quality_control/prompts/ROW-0170.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0170.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0170.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0170/`

Do not write the final `quality_control/results/ROW-0170.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) escolhem a regressão de Poisson porque ela estima a média condicional em nível e acomoda zeros diretamente.",
  "source_excerpt": "A pseudo-máxima verossimilhança de Poisson estima a média condicional em nível e acomoda os zeros diretamente. Essa é também a escolha de Brynjolfsson, Chandar e Chen (2025), que estimam regressão de Poisson pelo mesmo motivo.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0170`
- claim_row_sha256: `3e6d26aaf4bf14d4ab7a38b95bdf38b0ebe3be69a5ec1def71b3570c21c603d8`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0170.pdf`
