# Blind second-review task: ROW-0164
...
- This prompt: `quality_control/prompts/ROW-0164.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0164.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0164.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0164/`

Do not write the final `quality_control/results/ROW-0164.json`; the QC controller validates and commits it atomically.
...
{
  "claim_id": "CLM-125",
  "occurrence_id": "CIT-032",
  "section": "4.2 Construção do painel ocupação-mês com CAGED e crosswalk CBO → OIT",
  "paragraph": "5",
  ...
  "source_excerpt": "A janela é assimétrica, com mais tempo depois do evento do que antes, o que é prática corrente nesta literatura: Klein Teeselink (2025, p. 11) trabalha com 15 meses de pré e 30 de pós.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0164`
- claim_row_sha256: `4adaa19f21998faadbbdc0433c1d5cfa467ae2f3ee6c17d23ed59d9d801b157d`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0164.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0164`
- `worker_task_name`: `qc_row_0164`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0164.pdf`
