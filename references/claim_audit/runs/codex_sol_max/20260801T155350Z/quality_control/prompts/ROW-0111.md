# Blind second-review task: ROW-0111
...
- This prompt: `quality_control/prompts/ROW-0111.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0111.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0111.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0111/`

Do not write the final `quality_control/results/ROW-0111.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "O estudo acompanha o mercado de trabalho dos Estados Unidos usando registros de folha de pagamento da ADP.",
  "source_excerpt": "Para a estratégia empírica, a principal referência foi a abordagem de diferenças em diferenças e de estudo de eventos aplicados à difusão da IA feita por Brynjolfsson, Chandar e Chen (2025). Esse estudo acompanhou o mercado de trabalho americano a partir dos registros de folha de pagamento da ADP, uma das maiores processadoras de folha dos Estados Unidos, que paga salários para mais de 25 milhões de trabalhadores.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0111`
- claim_row_sha256: `850812daf8103065469c37acbc44c0b7d34a9099f2c7841f0d917726b6af5de4`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0111.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0111`
- `worker_task_name`: `qc_row_0111`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0111.pdf`
