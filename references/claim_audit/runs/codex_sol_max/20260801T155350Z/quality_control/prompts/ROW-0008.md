# Blind second-review task: ROW-0008
...
- This prompt: `quality_control/prompts/ROW-0008.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0008.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0008.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0008/`

Do not write the final `quality_control/results/ROW-0008.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0008`
- claim_row_sha256: `862df097489e7b3c57c89eea94a496011efda8ffb03484e663aba2192e25f186`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0008.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0008.pdf`
