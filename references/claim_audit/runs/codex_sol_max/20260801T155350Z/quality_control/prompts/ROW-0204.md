# Blind second-review task: ROW-0204
...
- This prompt: `quality_control/prompts/ROW-0204.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0204.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0204.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0204/`

Do not write the final `quality_control/results/ROW-0204.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Permanece válida, e agora isolada, a leitura da Subseção 3.5.1 e de Gmyrek et al. (2025) sobre a maior exposição ocupacional das mulheres à IA — que é uma afirmação sobre exposição potencial, e não sobre ajuste realizado.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0204`
- claim_row_sha256: `9e65cebb4e676f887a1d55b0f41e94af637d5f5774ae7fcf2627d522d93d390c`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0204.pdf`
