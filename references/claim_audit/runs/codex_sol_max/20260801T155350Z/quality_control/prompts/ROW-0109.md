# Blind second-review task: ROW-0109
...
- This prompt: `quality_control/prompts/ROW-0109.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0109.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0109.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0109/`

Do not write the final `quality_control/results/ROW-0109.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Esse achado tem peso analítico relevante para a Etapa 2 desta dissertação, em que avalio se essa coorte mais exposta sofreu efeitos diferenciados após o lançamento do ChatGPT, padrão já documentado por Brynjolfsson, Chandar e Chen (2025) nos Estados Unidos.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0109`
- claim_row_sha256: `64fb020ac6dd3eb004779cfbb92dbd1a481618767a00d6e2dd3c669db369addd`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0109.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0109`
- `worker_task_name`: `qc_row_0109`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0109.pdf`
