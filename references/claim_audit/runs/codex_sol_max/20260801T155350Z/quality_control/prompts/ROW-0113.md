# Blind second-review task: ROW-0113
...
- This prompt: `quality_control/prompts/ROW-0113.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0113.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0113.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0113/`

Do not write the final `quality_control/results/ROW-0113.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A ADP processa salários de mais de 25 milhões de trabalhadores.",
...
- row_id: `ROW-0113`
- claim_row_sha256: `a9f0d52360614ef3bbe2b008bcf243ef511ef08d7991ce7940933b7ffb89d663`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0113.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0113`
- `worker_task_name`: `qc_row_0113`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0113.pdf`
