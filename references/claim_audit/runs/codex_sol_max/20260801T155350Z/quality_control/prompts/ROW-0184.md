# Blind second-review task: ROW-0184
...
- This prompt: `quality_control/prompts/ROW-0184.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0184.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0184.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0184/`

Do not write the final `quality_control/results/ROW-0184.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) não encontram diferenças significativas no emprego agregado entre ocupações mais e menos expostas.",
  "source_excerpt": "Brynjolfsson, Chandar e Chen (2025), principal referência desta seção, também não encontram diferenças significativas no emprego agregado entre ocupações mais e menos expostas e enfrentam o mesmo problema de tendências paralelas: ocupações altamente expostas foram atingidas de forma distinta pela pandemia de Covid-19, o que contamina a linha de base anterior ao ChatGPT.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0184`
- claim_row_sha256: `ef8a122f728dc2bc3801d95263225f568452b37d32a2be98cfb23b6e66406c9b`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0184.pdf`
