# Blind second-review task: ROW-0200
...
- This prompt: `quality_control/prompts/ROW-0200.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0200.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0200.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0200/`

Do not write the final `quality_control/results/ROW-0200.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A redução das vagas apresenta cronologia semelhante à redução do estoque de emprego.",
  "source_excerpt": "A leitura de que os sinais negativos simultâneos em admissões e desligamentos refletem menor rotatividade, e não destruição de vínculos, também encontra respaldo direto: Hosseini Maasoum e Lichtinger (2025) mostram que a contração do emprego em firmas que adotam IA vem sobretudo da desaceleração das contratações, acompanhada de queda nos desligamentos, e Klein Teeselink (2025), no Reino Unido, documenta reduções tanto no emprego quanto nas novas vagas; o artigo descreve a queda das vagas como gradual e com cronologia semelhante à do estoque, não como anterior a qualquer ajuste no emprego.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0200`
- claim_row_sha256: `711adb877ceb7d583ad4bb44920bc357dba54287e1d423fbe1f2197036f709c1`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0200.pdf`
