# Blind second-review task: ROW-0090
...
- This prompt: `quality_control/prompts/ROW-0090.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0090.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0090.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0090/`

Do not write the final `quality_control/results/ROW-0090.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Anthropic Economic Index (Appel et al., 2026) | Dados reais de uso e estruturação O*NET / SOC (EUA) | Uso efetivo dos modelos; dimensões de autonomia e taxa de sucesso | Mede uso real; distingue automação de complementariedade | Viés de amostragem (apenas usuários de modelos específicos); base americana | Comparação",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0090`
- claim_row_sha256: `1299b1fd81521a6d7973949ed8249c23bc1994496ad8aa7fcb0f32eb53cbc517`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0090.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0090`
- `worker_task_name`: `qc_row_0090`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0090.pdf`
