# Blind second-review task: ROW-0125
...
- This prompt: `quality_control/prompts/ROW-0125.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0125.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0125.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0125/`

Do not write the final `quality_control/results/ROW-0125.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "O evento escolhido é o lançamento público do ChatGPT, em 30 de novembro de 2022, tratado como marco inicial da difusão dos LLMs (Large Language Models). Essa escolha dialoga com a literatura recente e é o evento usado no estudo de referência de Brynjolfsson, Chandar e Chen (2025).",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0125`
- claim_row_sha256: `5709ffacdbd18ebdb5ae22bb95f8d47ca2e4665fa1dc914184a2b1f9c9573512`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0125.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0125`
- `worker_task_name`: `qc_row_0125`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0125.pdf`
