# Blind second-review task: ROW-0092
...
- This prompt: `quality_control/prompts/ROW-0092.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0092.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0092.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0092/`

Do not write the final `quality_control/results/ROW-0092.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0092`
- claim_row_sha256: `b660750b84c7fe5efb25b385a24751f1287c5d6f49d2e5fca63be4951e8ebd5d`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0092.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0092`
- `worker_task_name`: `qc_row_0092`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0092.pdf`
