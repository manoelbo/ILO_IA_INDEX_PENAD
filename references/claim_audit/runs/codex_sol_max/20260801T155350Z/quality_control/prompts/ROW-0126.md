# Blind second-review task: ROW-0126
...
- This prompt: `quality_control/prompts/ROW-0126.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0126.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0126.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0126/`

Do not write the final `quality_control/results/ROW-0126.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Estimadores de diferenças em diferenças com efeitos fixos de duas vias podem produzir ponderações negativas quando as unidades são tratadas em momentos diferentes.",
...
- row_id: `ROW-0126`
- claim_row_sha256: `bb167f3e46b42bacfabe7f4bd6e1979845aa00d06c893f10cd9236a2d79d4bb1`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0126.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0126`
- `worker_task_name`: `qc_row_0126`
...
- `source_sha256`: `4f877146cba18f2d19781e2e5ea0be9275d698ef1295f166f7d1778bfc1e17fc`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0126.pdf`
