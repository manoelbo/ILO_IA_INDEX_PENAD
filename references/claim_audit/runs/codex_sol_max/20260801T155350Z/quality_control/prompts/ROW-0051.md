# Blind second-review task: ROW-0051
...
- This prompt: `quality_control/prompts/ROW-0051.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0051.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0051.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0051/`

Do not write the final `quality_control/results/ROW-0051.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A abordagem holística do GENOE permite capturar diferenças sociais e institucionais entre ocupações com tarefas informacionais semelhantes.",
...
- row_id: `ROW-0051`
- claim_row_sha256: `e840f523e11eb950479b3aec6463eb57f95e99ce149d08dbead9d10c30587d58`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0051.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0051.pdf`
