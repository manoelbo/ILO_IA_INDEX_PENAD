# Blind second-review task: ROW-0143
...
- This prompt: `quality_control/prompts/ROW-0143.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0143.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0143.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0143/`

Do not write the final `quality_control/results/ROW-0143.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0143`
- claim_row_sha256: `a69feba6b6fe017630c113598844d1d0e7972ea7f5ded4af6431a47c65eda6d8`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0143.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0143`
- `worker_task_name`: `qc_row_0143`
...
- `source_sha256`: `88cdd094589af58608a0d6675a00b57f36c8583d5f1e40e892e06a700307867f`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0143.pdf`
