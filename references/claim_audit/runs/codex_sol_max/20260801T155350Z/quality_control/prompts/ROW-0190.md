# Blind second-review task: ROW-0190
...
- This prompt: `quality_control/prompts/ROW-0190.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0190.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0190.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0190/`

Do not write the final `quality_control/results/ROW-0190.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Humlum e Vestergaard (2025) reportam efeitos nulos e precisos sobre horas trabalhadas mesmo dois anos após o ChatGPT.",
...
- row_id: `ROW-0190`
- claim_row_sha256: `3e344764328547650daeb183f130ad77d7aea2185910ba1bdf9d7eaff0c8f882`
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0190.pdf`
