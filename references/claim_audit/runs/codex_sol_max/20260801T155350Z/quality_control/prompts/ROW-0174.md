# Blind second-review task: ROW-0174
...
- This prompt: `quality_control/prompts/ROW-0174.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0174.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0174.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0174/`

Do not write the final `quality_control/results/ROW-0174.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "Se a IA substitui conhecimento codificado, trabalhadores jovens podem ser mais vulneráveis.",
...
- row_id: `ROW-0174`
- claim_row_sha256: `26f1fbedf2be5d5707daf3c2148ac58bf82c6a98cdbdada12f3d442f939cb50b`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0174.pdf`
