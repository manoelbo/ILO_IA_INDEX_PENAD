# Blind second-review task: ROW-0083
...
- This prompt: `quality_control/prompts/ROW-0083.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0083.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0083.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0083/`

Do not write the final `quality_control/results/ROW-0083.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O GENOE é apresentado como não validado por profissionais.",
...
- row_id: `ROW-0083`
- claim_row_sha256: `5fb9329ed413bfcfdad3e923bdd7aa5e33113b4349b6ff29db8d60548ff8e1d1`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0083.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0083`
- `worker_task_name`: `qc_row_0083`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0083.pdf`
