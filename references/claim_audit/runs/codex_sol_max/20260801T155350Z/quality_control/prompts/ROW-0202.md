# Blind second-review task: ROW-0202
...
- This prompt: `quality_control/prompts/ROW-0202.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0202.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0202.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0202/`

Do not write the final `quality_control/results/ROW-0202.json`; the QC controller validates and commits it atomically.
...
{
  "claim_id": "CLM-163",
  "occurrence_id": "CIT-046",
  "section": "5.2.1 Efeitos por Sexo",
  "paragraph": "9",
  ...
  "source_excerpt": "O resultado converge com Brynjolfsson, Chandar e Chen (2025), que também não encontram efeitos diferenciais por sexo nos Estados Unidos.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0202`
- claim_row_sha256: `703c32a289247798dff9f9bdf12ff60770448bad07a0b3dc7fe03cd11932ee04`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0202.pdf`
