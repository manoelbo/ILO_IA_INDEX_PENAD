# Blind second-review task: ROW-0007
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0007`
...
- This prompt: `quality_control/prompts/ROW-0007.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0007.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0007.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0007/`

Do not write the final `quality_control/results/ROW-0007.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Estudos recentes nos Estados Unidos e no Reino Unido convergem para a conclusão de que o impacto da IA está se manifestando principalmente na porta de entrada do mercado de trabalho.",
...
- row_id: `ROW-0007`
- claim_row_sha256: `91121de416b84f56c57332645658e31db95eae42b082180143cf8d73850acb2f`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0007.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0007`
- `worker_task_name`: `retry1_qc_row_0007`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0007.pdf`
