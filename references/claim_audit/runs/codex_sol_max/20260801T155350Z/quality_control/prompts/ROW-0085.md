# Blind second-review task: ROW-0085
...
- This prompt: `quality_control/prompts/ROW-0085.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0085.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0085.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0085/`

Do not write the final `quality_control/results/ROW-0085.json`; the QC controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0085.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0085`
- `worker_task_name`: `qc_row_0085`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0085.pdf`
