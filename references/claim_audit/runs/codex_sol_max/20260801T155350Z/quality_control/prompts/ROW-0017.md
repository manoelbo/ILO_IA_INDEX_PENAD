# Blind second-review task: ROW-0017
...
- This prompt: `quality_control/prompts/ROW-0017.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0017.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0017.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0017/`

Do not write the final `quality_control/results/ROW-0017.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0017`
- claim_row_sha256: `7faeb7478b9ee46c26842f2630f26fe8bf556fd4a4940baeee3ad03da9acdbb9`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0017.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0017`
- `worker_task_name`: `qc_row_0017`
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0017.pdf`
