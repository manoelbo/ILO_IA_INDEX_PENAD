# Blind second-review task: ROW-0009
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0009`
...
- This prompt: `quality_control/prompts/ROW-0009.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0009.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0009.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0009/`

Do not write the final `quality_control/results/ROW-0009.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0009`
- claim_row_sha256: `b2b9b3d1b55fcb752f53b229b8e483b8db9ef281648dfde6c4ddf8e46ad12b56`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0009.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0009`
- `worker_task_name`: `retry1_qc_row_0009`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0009.pdf`
