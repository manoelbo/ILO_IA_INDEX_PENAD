# Blind second-review task: ROW-0197
...
- This prompt: `quality_control/prompts/ROW-0197.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0197.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0197.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0197/`

Do not write the final `quality_control/results/ROW-0197.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "No Reino Unido, Klein Teeselink (2025) documenta redução do emprego.",
...
- row_id: `ROW-0197`
- claim_row_sha256: `f0bc0b3975f698b1ec8a68706afd3fd8b08666aea6ef5a0e87c55dc6a6fdf34d`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0197.pdf`
