# Blind second-review task: ROW-0122
...
- This prompt: `quality_control/prompts/ROW-0122.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0122.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0122.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0122/`

Do not write the final `quality_control/results/ROW-0122.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "O principal ajuste identificado pelo estudo concentra-se na porta de entrada do mercado de trabalho.",
...
- row_id: `ROW-0122`
- claim_row_sha256: `1d2d95244195a0ad727a07b8f090433bb0abd0af0001a5f7e49d6403e0a7fa15`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0122.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0122`
- `worker_task_name`: `qc_row_0122`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0122.pdf`
