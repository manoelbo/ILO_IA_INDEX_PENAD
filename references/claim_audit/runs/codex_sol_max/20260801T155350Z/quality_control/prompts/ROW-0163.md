# Blind second-review task: ROW-0163
...
- This prompt: `quality_control/prompts/ROW-0163.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0163.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0163.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0163/`

Do not write the final `quality_control/results/ROW-0163.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Humlum e Vestergaard (2025) citam cinco trabalhos que adotam novembro de 2022 como referência do estudo de eventos.",
  "source_excerpt": "Registre-se ainda que a escolha de novembro de 2022 como referência do estudo de eventos não é idiossincrática. Humlum e Vestergaard (2025, p. 12, nota 8) observam que estudos de evento centrados nessa data se tornaram comuns na literatura e citam cinco trabalhos que a adotam.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0163`
- claim_row_sha256: `9a4787a8eb4a4f1cf129bc02a384d3ebfc0ca8a4c6cbafe96975e3b87089b196`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0163.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0163`
- `worker_task_name`: `qc_row_0163`
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0163.pdf`
