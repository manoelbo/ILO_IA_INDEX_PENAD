# Blind second-review task: ROW-0015
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0015`
...
- This prompt: `quality_control/prompts/ROW-0015.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0015.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0015.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0015/`

Do not write the final `quality_control/results/ROW-0015.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0015`
- claim_row_sha256: `3a42b9e0045a77a9ba97ec4fc3cb9ae042ab09973d8c0137a035165e4cfddfee`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0015.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0015`
- `worker_task_name`: `retry1_qc_row_0015`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0015.pdf`
