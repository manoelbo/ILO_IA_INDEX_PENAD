# Blind second-review task: ROW-0110
...
- This prompt: `quality_control/prompts/ROW-0110.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0110.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0110.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0110/`

Do not write the final `quality_control/results/ROW-0110.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) são a principal referência para a abordagem de diferenças em diferenças e estudo de eventos aplicada à difusão da IA.",
  "source_excerpt": "Para a estratégia empírica, a principal referência foi a abordagem de diferenças em diferenças e de estudo de eventos aplicados à difusão da IA feita por Brynjolfsson, Chandar e Chen (2025).",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0110`
- claim_row_sha256: `45013022c3f002b62791215505fa10054a1df9e6d6dcff8a35635ce7a237be12`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0110.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0110`
- `worker_task_name`: `qc_row_0110`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0110.pdf`
