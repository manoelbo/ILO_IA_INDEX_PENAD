# Blind second-review task: ROW-0205
...
- This prompt: `quality_control/prompts/ROW-0205.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0205.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0205.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0205/`

Do not write the final `quality_control/results/ROW-0205.json`; the QC controller validates and commits it atomically.
...
{
  "claim_id": "CLM-166",
  "occurrence_id": "CIT-048",
  "section": "5.2.2 Efeitos por raça/cor",
  "paragraph": "10",
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Os estudos de Brynjolfsson, Chandar e Chen (2025), Hosseini Maasoum e Lichtinger (2025) e Klein Teeselink (2025) não apresentam estimativas causais desagregadas por raça.",
  "source_excerpt": "A comparação internacional permanece limitada, pois os principais estudos empíricos mobilizados nesta dissertação não apresentam estimativas causais desagregadas por raça (Brynjolfsson; Chandar; Chen, 2025; Hosseini Maasoum; Lichtinger, 2025; Klein Teeselink, 2025).",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0205`
- claim_row_sha256: `2546e8f99c0222cd3a46e9b7640ba83cc2f5bdf0e9806f79598e569fe5cac0e2`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0205.pdf`
