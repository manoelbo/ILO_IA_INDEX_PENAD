# Blind second-review task: ROW-0066
...
- This prompt: `quality_control/prompts/ROW-0066.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0066.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0066.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0066/`

Do not write the final `quality_control/results/ROW-0066.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "O ILO Global Index incorpora a média das tarefas de cada ocupação.",
...
- row_id: `ROW-0066`
- claim_row_sha256: `e30cd288abfdabe360d34c84c924fe949fee2cebf69093c560fafb9a2205efc0`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0066.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0066`
- `worker_task_name`: `qc_row_0066`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0066.pdf`
