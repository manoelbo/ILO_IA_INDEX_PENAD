# Blind second-review task: ROW-0012
...
- This prompt: `quality_control/prompts/ROW-0012.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0012.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0012.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0012/`

Do not write the final `quality_control/results/ROW-0012.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0012`
- claim_row_sha256: `071ea2f1e43faa49787ca756ec14adb629cff7c0b08230439e0cc9e1f1a0e498`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0012.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0012.pdf`
