# Blind second-review task: ROW-0054
...
- This prompt: `quality_control/prompts/ROW-0054.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0054.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0054.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0054/`

Do not write the final `quality_control/results/ROW-0054.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0054`
- claim_row_sha256: `3fb56a9675b0c5109f7fca0e1de98f777de01185828aa16015cdb49b3db64da8`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0054.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0054`
- `worker_task_name`: `qc_row_0054`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0054.pdf`
