# Blind second-review task: ROW-0148
...
- Fallback: prohibited
- Worker task name: `retry1_qc_row_0148`
...
- This prompt: `quality_control/prompts/ROW-0148.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0148.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0148.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0148/`

Do not write the final `quality_control/results/ROW-0148.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0148`
- claim_row_sha256: `a505958de39d3859655542ff189cfabfbf2067a6112ad587c48e9dd88038691d`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0148.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0148`
- `worker_task_name`: `retry1_qc_row_0148`
...
- `source_sha256`: `4562d82bed76a712e3a1fe1831beb8a38962062524fa36483875ba5fe059bc9c`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0148.pdf`
