# Blind second-review task: ROW-0185
...
- This prompt: `quality_control/prompts/ROW-0185.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0185.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0185.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0185/`

Do not write the final `quality_control/results/ROW-0185.json`; the QC controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) enfrentam um problema de tendências paralelas.",
...
- row_id: `ROW-0185`
- claim_row_sha256: `f3b566661bf25d5bc43d3dd707bd41c3038b35a6b485284c7aff0a385af5f7f6`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0185.pdf`
