# Blind second-review task: ROW-0003
...
- This prompt: `quality_control/prompts/ROW-0003.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0003.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0003.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0003/`

Do not write the final `quality_control/results/ROW-0003.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0003`
- claim_row_sha256: `e72470454ca078a5b2fa5e2e8e7d10a30f16dbcb0c40b9cce3c48a3777502517`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0003.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.
...
- `source_sha256`: `852097fc72812af45bd3693d7a661c70457eb674ab8f493cadb268450e556b5b`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0003.pdf`
