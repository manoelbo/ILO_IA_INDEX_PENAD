# Blind second-review task: ROW-0070
...
- This prompt: `quality_control/prompts/ROW-0070.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0070.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0070.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0070/`

Do not write the final `quality_control/results/ROW-0070.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0070`
- claim_row_sha256: `8a968e1125fed520105d8c18c30115bcf14e4221020a46d507fab123b36f911e`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0070.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0070`
- `worker_task_name`: `qc_row_0070`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0070.pdf`
