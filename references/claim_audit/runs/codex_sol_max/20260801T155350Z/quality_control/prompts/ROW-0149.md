# Blind second-review task: ROW-0149
...
- This prompt: `quality_control/prompts/ROW-0149.md`
...
- Candidate JSON only: `quality_control/candidates/ROW-0149.candidate.json`
- Exact evidence PDF only: `quality_control/evidence_pages/ROW-0149.pdf`
- Optional selected-page PNG renders only inside: `quality_control/renders/ROW-0149/`

Do not write the final `quality_control/results/ROW-0149.json`; the QC controller validates and commits it atomically.
...
- row_id: `ROW-0149`
- claim_row_sha256: `b0a10888052d115bdf570535b23a72cb6410fcd452a4ded8a5f80b9e9d84a3ed`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `quality_control/evidence_pages/ROW-0149.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one independent JSON object conforming exactly to `quality_control/qc_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0149`
- `worker_task_name`: `qc_row_0149`
...
- `source_sha256`: `ddc65e7599d8364181fd84d388ec543d57bfa51c2e66d50777af7ebac2aba3c4`
- `schema_sha256`: `e478b8113d3ed5fabc02f101e4746e9a627dd6657ecfeed2e86fbef8f9ca6dde`
- `evidence_path`: `quality_control/evidence_pages/ROW-0149.pdf`
