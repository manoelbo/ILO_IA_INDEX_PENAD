# Isolated claim audit task: ROW-0194
...
- Fallback: prohibited
- Worker task name: `claim_row_0194`
...
- This prompt: `source_build/prompts/ROW-0194.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0194.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0194.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0194/`

Do not write the final `results/ROW-0194.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Aldasoro et al. (2026) não encontram efeito adverso de curto prazo sobre o emprego no nível da firma.",
...
- row_id: `ROW-0194`
- claim_row_sha256: `bfd6045a16023cf4faba9781d27071f45400f44d86654a330fbcd090b77df34e`
...
- `source_sha256`: `fa7429942e4314dbe0756b5df338dc2656fc4bd6440dfe1ee1e5094af025fbdd`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0194.pdf`
