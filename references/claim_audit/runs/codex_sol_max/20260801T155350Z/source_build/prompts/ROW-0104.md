# Isolated claim audit task: ROW-0104
...
- Fallback: prohibited
- Worker task name: `claim_row_0104`
...
- This prompt: `source_build/prompts/ROW-0104.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0104.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0104.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0104/`

Do not write the final `results/ROW-0104.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A escolha do ILO Global Index apoia-se na robustez metodológica de sua construção.",
...
- row_id: `ROW-0104`
- claim_row_sha256: `3900d24706ba757e6224ba5b1f4505ec8e31469467e5f4f1f3bbadab6f056df0`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0104.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0104`
- `worker_task_name`: `claim_row_0104`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0104.pdf`
