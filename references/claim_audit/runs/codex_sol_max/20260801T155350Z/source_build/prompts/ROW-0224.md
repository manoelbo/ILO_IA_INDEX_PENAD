# Isolated claim audit task: ROW-0224
...
- Fallback: prohibited
- Worker task name: `claim_row_0224`
...
- This prompt: `source_build/prompts/ROW-0224.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0224.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0224.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0224/`

Do not write the final `results/ROW-0224.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) localizam o ajuste mais visível entre trabalhadores mais jovens em ocupações ligadas a software e atendimento.",
...
- row_id: `ROW-0224`
- claim_row_sha256: `d8d680e3e213c7767ebb4bd70f9b5d9b9db9d4cc4a1ec0c04b86cb520c51b83b`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0224.pdf`
