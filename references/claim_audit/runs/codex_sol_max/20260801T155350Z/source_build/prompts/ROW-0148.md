# Isolated claim audit task: ROW-0148
...
- Fallback: prohibited
- Worker task name: `claim_row_0148`
...
- This prompt: `source_build/prompts/ROW-0148.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0148.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0148.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0148/`

Do not write the final `results/ROW-0148.json`; the controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0148.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0148`
- `worker_task_name`: `claim_row_0148`
...
- `source_sha256`: `4562d82bed76a712e3a1fe1831beb8a38962062524fa36483875ba5fe059bc9c`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0148.pdf`
