# Isolated claim audit task: ROW-0178
...
- Fallback: prohibited
- Worker task name: `claim_row_0178`
...
- This prompt: `source_build/prompts/ROW-0178.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0178.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0178.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0178/`

Do not write the final `results/ROW-0178.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `a64350970c9252167ef65c3fa693d47c8e5eb84c4ae22841f8c2006db0d24802`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0178.pdf`
