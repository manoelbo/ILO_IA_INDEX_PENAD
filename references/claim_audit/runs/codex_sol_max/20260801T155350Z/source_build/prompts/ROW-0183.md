# Isolated claim audit task: ROW-0183
...
- Fallback: prohibited
- Worker task name: `claim_row_0183`
...
- This prompt: `source_build/prompts/ROW-0183.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0183.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0183.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0183/`

Do not write the final `results/ROW-0183.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O procedimento de Rambachan e Roth (2023) substitui um teste binário de tendências paralelas por uma análise de quanta violação o resultado suporta.",
...
- row_id: `ROW-0183`
- claim_row_sha256: `f58c1c53cf99c9ce95a0bb8524230f475889c80872d24ea94c3e3b3952f30317`
...
- `source_sha256`: `2ef3448e51bb946478ad323b8e00fc5de80fcc1b274ec26aa01dfaa9e458b7dc`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0183.pdf`
