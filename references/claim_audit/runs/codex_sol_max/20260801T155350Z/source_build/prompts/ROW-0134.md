# Isolated claim audit task: ROW-0134
...
- Fallback: prohibited
- Worker task name: `claim_row_0134`
...
- This prompt: `source_build/prompts/ROW-0134.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0134.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0134.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0134/`

Do not write the final `results/ROW-0134.json`; the controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0134.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0134`
- `worker_task_name`: `claim_row_0134`
...
- `source_sha256`: `4f877146cba18f2d19781e2e5ea0be9275d698ef1295f166f7d1778bfc1e17fc`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0134.pdf`
