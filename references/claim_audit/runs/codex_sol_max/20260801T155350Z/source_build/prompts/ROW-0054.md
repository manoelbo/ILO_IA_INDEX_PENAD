# Isolated claim audit task: ROW-0054
...
- Fallback: prohibited
- Worker task name: `claim_row_0054`
...
- This prompt: `source_build/prompts/ROW-0054.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0054.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0054.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0054/`

Do not write the final `results/ROW-0054.json`; the controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0054.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0054`
- `worker_task_name`: `claim_row_0054`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0054.pdf`
