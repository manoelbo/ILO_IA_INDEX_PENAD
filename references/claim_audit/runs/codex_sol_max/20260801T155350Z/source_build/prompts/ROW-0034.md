# Isolated claim audit task: ROW-0034
...
- Fallback: prohibited
- Worker task name: `claim_row_0034`
...
- This prompt: `source_build/prompts/ROW-0034.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0034.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0034.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0034/`

Do not write the final `results/ROW-0034.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Seu ponto de partida é o trabalho seminal de Autor, Levy e Murnane (2003), segundo o qual um emprego é, na prática, um conjunto de tarefas. Essa abordagem muda nossa perspectiva de maneira objetiva: novas tecnologias não impactam ocupações inteiras de forma homogênea, elas impactam as tarefas que constituem essas ocupações.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0034`
- claim_row_sha256: `ea55339c289905596b817229ff0fb9fd45058cb23b2ec715895c422f0cb906ab`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0034.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0034`
- `worker_task_name`: `claim_row_0034`
...
- `source_sha256`: `f4f159ef84aecd49767b43ac2dad9871929e94283587be868b7d04d54d1c2488`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0034.pdf`
