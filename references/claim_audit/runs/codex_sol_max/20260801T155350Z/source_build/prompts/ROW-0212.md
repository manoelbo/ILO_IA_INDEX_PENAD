# Isolated claim audit task: ROW-0212
...
- Fallback: prohibited
- Worker task name: `claim_row_0212`
...
- This prompt: `source_build/prompts/ROW-0212.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0212.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0212.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0212/`

Do not write the final `results/ROW-0212.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "affirmation_pt": "A diferença entre os resultados pode decorrer das diferenças de desenho entre os estudos.",
...
- row_id: `ROW-0212`
- claim_row_sha256: `eb2733aa6e745a63fa1c69a0e08b1e2bac576fb12e6f21c5b023de9b5e4740db`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0212.pdf`
