# Isolated claim audit task: ROW-0217
...
- Fallback: prohibited
- Worker task name: `claim_row_0217`
...
- This prompt: `source_build/prompts/ROW-0217.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0217.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0217.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0217/`

Do not write the final `results/ROW-0217.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Também é compatível com Klein Teeselink (2025), que encontra efeitos concentrados em firmas e ocupações de alta remuneração no Reino Unido. A comparação não é direta, pois remuneração não equivale a escolaridade.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0217`
- claim_row_sha256: `bbf7ac3a255b80458bf0c4741f5c3b2c04ec7d630dcdbca7ab5f605791eb7673`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0217.pdf`
