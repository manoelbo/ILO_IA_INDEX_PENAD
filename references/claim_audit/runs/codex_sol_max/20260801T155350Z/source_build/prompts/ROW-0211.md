# Isolated claim audit task: ROW-0211
...
- Fallback: prohibited
- Worker task name: `claim_row_0211`
...
- This prompt: `source_build/prompts/ROW-0211.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0211.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0211.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0211/`

Do not write the final `results/ROW-0211.json`; the controller validates and commits it atomically.
...
{
  "claim_id": "CLM-170",
  "occurrence_id": "CIT-052",
  "section": "5.2.3 Efeitos por faixa etária",
  "paragraph": "9",
  ...
  "affirmation_pt": "A comparação exige cautela porque o estudo de referência localiza o contraste nos jovens, enquanto o contraste brasileiro decorre da ausência de efeito entre trabalhadores de 41 a 49 anos.",
  "source_excerpt": "Os resultados brasileiros não reproduzem, nas admissões, a concentração do efeito entre 22 e 25 anos encontrada por Brynjolfsson, Chandar e Chen (2025), que reportam queda de cerca de 12 pontos log para essa coorte. A comparação precisa ser feita com cuidado, porque os dois trabalhos localizam o contraste em pontos diferentes da distribuição etária: lá, o efeito está nos jovens; aqui, o que gera o contraste é a ausência de efeito entre os de 41 a 49 anos. A diferença pode decorrer dos desenhos: os autores analisam o estoque de emprego em firmas e comparam quintis de exposição, com efeitos concentrados nos níveis mais elevados, enquanto o contraste desta subseção vem de fluxos mensais de admissões e desligamentos por ocupação, com classificação binária mais ampla.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0211`
- claim_row_sha256: `e3da5dd04cdd32fa36a1f1084bb44b67a287c6de8c7b15ac2ef0e53187a6cc85`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0211.pdf`
