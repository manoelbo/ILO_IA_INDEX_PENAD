# Isolated claim audit task: ROW-0079
...
- Fallback: prohibited
- Worker task name: `retry3_claim_row_0079`
...
- This prompt: `source_build/prompts/ROW-0079.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0079.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0079.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0079/`

Do not write the final `results/ROW-0079.json`; the controller validates and commits it atomically.
...
- row_id: `ROW-0079`
- claim_row_sha256: `69b334b7cdf0d9766c719c10673fe7dfbb81e09706f5c16c699d243502991808`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0079.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0079`
- `worker_task_name`: `retry3_claim_row_0079`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0079.pdf`
