# Isolated claim audit task: ROW-0195
...
- Fallback: prohibited
- Worker task name: `claim_row_0195`
...
- This prompt: `source_build/prompts/ROW-0195.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0195.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0195.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0195/`

Do not write the final `results/ROW-0195.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0195.pdf`
