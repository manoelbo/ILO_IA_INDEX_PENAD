# Isolated claim audit task: ROW-0069
...
- Fallback: prohibited
- Worker task name: `claim_row_0069`
...
- This prompt: `source_build/prompts/ROW-0069.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0069.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0069.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0069/`

Do not write the final `results/ROW-0069.json`; the controller validates and commits it atomically.
...
- row_id: `ROW-0069`
- claim_row_sha256: `5b73eb92f21215291e38d5e9cdd5a28000de706520f8c6d1739068f8431abb63`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0069.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0069`
- `worker_task_name`: `claim_row_0069`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0069.pdf`
