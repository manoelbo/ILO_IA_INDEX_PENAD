# Isolated claim audit task: ROW-0192
...
- Fallback: prohibited
- Worker task name: `retry1_claim_row_0192`
...
- This prompt: `source_build/prompts/ROW-0192.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0192.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0192.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0192/`

Do not write the final `results/ROW-0192.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Aldasoro et al. (2026) analisam mais de 12 mil firmas não financeiras da União Europeia e dos Estados Unidos.",
...
- row_id: `ROW-0192`
- claim_row_sha256: `850324e358705925bef1fec3bfefa5194899c0c57ae62e61b033aacf7a225b92`
...
- `source_sha256`: `fa7429942e4314dbe0756b5df338dc2656fc4bd6440dfe1ee1e5094af025fbdd`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0192.pdf`
