# Isolated claim audit task: ROW-0155
...
- Fallback: prohibited
- Worker task name: `retry1_claim_row_0155`
...
- This prompt: `source_build/prompts/ROW-0155.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0155.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0155.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0155/`

Do not write the final `results/ROW-0155.json`; the controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0155.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0155`
- `worker_task_name`: `retry1_claim_row_0155`
...
- `source_sha256`: `88cdd094589af58608a0d6675a00b57f36c8583d5f1e40e892e06a700307867f`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0155.pdf`
