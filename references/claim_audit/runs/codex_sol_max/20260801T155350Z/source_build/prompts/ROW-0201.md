# Isolated claim audit task: ROW-0201
...
- Fallback: prohibited
- Worker task name: `claim_row_0201`
...
- This prompt: `source_build/prompts/ROW-0201.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0201.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0201.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0201/`

Do not write the final `results/ROW-0201.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0201.pdf`
