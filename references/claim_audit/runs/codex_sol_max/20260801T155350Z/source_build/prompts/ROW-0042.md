# Isolated claim audit task: ROW-0042
...
- Fallback: prohibited
- Worker task name: `claim_row_0042`
...
- This prompt: `source_build/prompts/ROW-0042.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0042.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0042.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0042/`

Do not write the final `results/ROW-0042.json`; the controller validates and commits it atomically.
...
- row_id: `ROW-0042`
- claim_row_sha256: `3a7e46a93900274eaf6e38b3ca5eac294f385ce01a4cbc519764dec7918cb40e`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0042.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0042`
- `worker_task_name`: `claim_row_0042`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0042.pdf`
