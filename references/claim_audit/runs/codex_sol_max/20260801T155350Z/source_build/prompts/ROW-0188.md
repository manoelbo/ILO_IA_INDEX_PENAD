# Isolated claim audit task: ROW-0188
...
- Fallback: prohibited
- Worker task name: `claim_row_0188`
...
- This prompt: `source_build/prompts/ROW-0188.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0188.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0188.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0188/`

Do not write the final `results/ROW-0188.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `78bb1c90d5b5583d55b1b5d311bfaaa6792871f2ce05295856b7d0357a830049`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0188.pdf`
