# Isolated claim audit task: ROW-0047
...
- Fallback: prohibited
- Worker task name: `claim_row_0047`
...
- This prompt: `source_build/prompts/ROW-0047.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0047.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0047.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0047/`

Do not write the final `results/ROW-0047.json`; the controller validates and commits it atomically.
...
- row_id: `ROW-0047`
- claim_row_sha256: `0f3aaafa788c2ed1d4ab6175770b91545a71db8011f6c7950cd715d4f708f3bc`
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0047.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0047`
- `worker_task_name`: `claim_row_0047`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0047.pdf`
