# Isolated claim audit task: ROW-0182
...
- Fallback: prohibited
- Worker task name: `claim_row_0182`
...
- This prompt: `source_build/prompts/ROW-0182.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0182.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0182.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0182/`

Do not write the final `results/ROW-0182.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O procedimento de Rambachan e Roth (2023) contempla restrições de suavidade.",
...
- row_id: `ROW-0182`
- claim_row_sha256: `7378bdea36fd9a116ee0493e84603f797688cb9bb39726124df0ab6d09835d94`
...
- `source_sha256`: `2ef3448e51bb946478ad323b8e00fc5de80fcc1b274ec26aa01dfaa9e458b7dc`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0182.pdf`
