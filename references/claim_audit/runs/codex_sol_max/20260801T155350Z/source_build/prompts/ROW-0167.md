# Isolated claim audit task: ROW-0167
...
- Fallback: prohibited
- Worker task name: `claim_row_0167`
...
- This prompt: `source_build/prompts/ROW-0167.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0167.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0167.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0167/`

Do not write the final `results/ROW-0167.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `1085f4f7a368d8ae68202bcc0b9bafce2de8dc58ec1f1cbbad0f4a2fed88ae9e`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0167.pdf`
