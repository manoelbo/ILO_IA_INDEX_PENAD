# Isolated claim audit task: ROW-0223
...
- Fallback: prohibited
- Worker task name: `retry1_claim_row_0223`
...
- This prompt: `source_build/prompts/ROW-0223.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0223.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0223.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0223/`

Do not write the final `results/ROW-0223.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "source_excerpt": "Já a ausência de efeitos salariais é compatível com Brynjolfsson, Chandar e Chen (2025), que encontram ajustes mais visíveis no emprego do que na remuneração.",
  "fact_checked": "",
  "pages": ""
}
```
...
- row_id: `ROW-0223`
- claim_row_sha256: `df9011aaae94fefa9614137e8899c6c0d522daceb09b513da40c88f06e585321`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0223.pdf`
