# Isolated claim audit task: ROW-0117
...
- Fallback: prohibited
- Worker task name: `retry1_claim_row_0117`
...
- This prompt: `source_build/prompts/ROW-0117.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0117.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0117.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0117/`

Do not write the final `results/ROW-0117.json`; the controller validates and commits it atomically.
...
Extract only the exact supporting, conflicting, or diagnostic page range into `evidence_pages/ROW-0117.pdf`. Use PyPDF2 with the physical one-based indices and preserve source pages without modification. The evidence file must exist even for a non-pass result.

Produce one JSON object conforming exactly to `claim_result.schema.json`. Set:

- `schema_version`: `1.0.0`
- `row_id`: `ROW-0117`
- `worker_task_name`: `retry1_claim_row_0117`
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0117.pdf`
