# Isolated claim audit task: ROW-0177
...
- Fallback: prohibited
- Worker task name: `claim_row_0177`
...
- This prompt: `source_build/prompts/ROW-0177.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0177.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0177.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0177/`

Do not write the final `results/ROW-0177.json`; the controller validates and commits it atomically.
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A dissertação aplica o procedimento de Benjamini-Hochberg sobre famílias de testes declaradas antes da estimação.",
...
- row_id: `ROW-0177`
- claim_row_sha256: `8a42706d7a62201bfe4d85bd67e9abdb8998951780a52f1ba1ff1efa83cda129`
...
- `source_sha256`: `9869393631f0bd2ced0932ee405d26e241f6d0fd672bf1efecb72be287ff45da`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0177.pdf`
