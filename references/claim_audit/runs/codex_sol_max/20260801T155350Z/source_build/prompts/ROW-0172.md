# Isolated claim audit task: ROW-0172
...
- Fallback: prohibited
- Worker task name: `claim_row_0172`
...
- This prompt: `source_build/prompts/ROW-0172.md`
...
- Candidate JSON only: `source_build/candidates/ROW-0172.candidate.json`
- Exact evidence PDF only: `evidence_pages/ROW-0172.pdf`
- Optional selected-page PNG renders only inside: `source_build/renders/ROW-0172/`

Do not write the final `results/ROW-0172.json`; the controller validates and commits it atomically.
...
- `source_sha256`: `75012cdca09a734e64e6dd75e635551286549343dd7549252284dea9dc454a7d`
- `schema_sha256`: `4dd4f18341a047aa8370262cd83b4e6b51ffd765ee90d7c68d18bf9a063fb7d5`
- `evidence_path`: `evidence_pages/ROW-0172.pdf`
