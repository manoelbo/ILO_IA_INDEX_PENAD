# Blind second-review task: ROW-CUR-0006
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/quality_control/candidates/ROW-CUR-0006.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/quality_control/evidence_pages/ROW-CUR-0006.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/quality_control/renders/ROW-CUR-0006/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O GPT Exposure passou a usar os próprios modelos de linguagem como avaliadores das tarefas.",
...
Technical identity:
- row_id: `ROW-CUR-0006`
- claim_row_sha256: `f668bb4a8ee2b0fa1f0335579742e2e2511d37d9eb67808c0c86448f1a3b4458`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/quality_control/prompts/ROW-CUR-0006.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `quality_control/qc_result.schema.json` at `quality_control/candidates/ROW-CUR-0006.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0006`
- `claim_id`: `CLM-CUR-006`
- `occurrence_id`: `CIT-CUR-002`
- `worker_task_name`: `qc_row_0006`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `2da011643de0e2f499eae99624089bb116242de63deeb95838b14636cf5fab34`
- `evidence_path`: `quality_control/evidence_pages/ROW-CUR-0006.pdf`
