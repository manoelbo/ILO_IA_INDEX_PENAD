# Isolated current claim audit: ROW-CUR-0075
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0075`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0075.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0075.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0075/`
...
```json
{
  ...
  "affirmation_pt": "O GPT Exposure exerce o papel de referência conceitual nesta dissertação.",
...
Technical identity:
- row_id: `ROW-CUR-0075`
- claim_row_sha256: `6c4b5badca2145d0d4aad07e684f4483075924bf247f2974ee41656fd92ec50c`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0075.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0075.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0075`
- `claim_id`: `CLM-CUR-065`
- `occurrence_id`: `CIT-CUR-015`
- `worker_task_name`: `current_claim_row_0075`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0075.pdf`
