# Isolated current claim audit: ROW-CUR-0091
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0091`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0091.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0091.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0091/`
...
```json
{
  ...
  "affirmation_pt": "O Anthropic Economic Index é utilizado apenas como índice de comparação nesta dissertação.",
...
Technical identity:
- row_id: `ROW-CUR-0091`
- claim_row_sha256: `1de7c384258f2913c9942658058b3eea32ec509f60e43727dc77f2e36da91fe8`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0091.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0091.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0091`
- `claim_id`: `CLM-CUR-081`
- `occurrence_id`: `CIT-CUR-017`
- `worker_task_name`: `current_claim_row_0091`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0091.pdf`
