# Isolated current claim audit: ROW-CUR-0082
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0082`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0082.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0082.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0082/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A aferição do GENOE é indireta, por meio da replicação do AIOE.",
...
Technical identity:
- row_id: `ROW-CUR-0082`
- claim_row_sha256: `a7a2ef78883e9d1421944154b72d19551e2ec137849be7a2960935afbd51b69b`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0082.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0082.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0082`
- `claim_id`: `CLM-CUR-072`
- `occurrence_id`: `CIT-CUR-016`
- `worker_task_name`: `current_claim_row_0082`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0082.pdf`
