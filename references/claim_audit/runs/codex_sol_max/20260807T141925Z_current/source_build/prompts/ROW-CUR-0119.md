# Isolated current claim audit: ROW-CUR-0119
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0119`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0119.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0119.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0119/`
...
{
  "row_id": "ROW-CUR-0119",
  "claim_id": "CLM-CUR-109",
  "occurrence_id": "CIT-CUR-027",
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) usam o lançamento público do ChatGPT, em 30 de novembro de 2022, como evento do estudo.",
  "source_excerpt": "O evento escolhido é o lançamento público do ChatGPT, em 30 de novembro de 2022, tratado como marco inicial da difusão dos LLMs. Essa escolha dialoga com a literatura recente e é o evento usado no estudo de referência de Brynjolfsson, Chandar e Chen (2025).",
...
Technical identity:
- row_id: `ROW-CUR-0119`
- claim_row_sha256: `36b947568dfd0b149f565c17b02de31f1e06e7180f0736f11efff0f03abcbe9c`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0119.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0119.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0119`
- `claim_id`: `CLM-CUR-109`
- `occurrence_id`: `CIT-CUR-027`
- `worker_task_name`: `current_claim_row_0119`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0119.pdf`
