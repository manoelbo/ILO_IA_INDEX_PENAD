# Isolated current claim audit: ROW-CUR-0195
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0195`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0195.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0195.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0195/`
...
{
  "row_id": "ROW-CUR-0195",
  "claim_id": "CLM-CUR-157",
  "occurrence_id": "CIT-CUR-052",
  ...
  "affirmation_pt": "A dissertação observa fluxos mensais por ocupação e usa uma classificação binária mais ampla, de modo que a comparação com o estudo de referência exige cautela.",
  "source_excerpt": "Nas admissões, as estimativas brasileiras não reproduzem o padrão concentrado entre 22 e 25 anos reportado por Brynjolfsson, Chandar e Chen (2025), de queda de cerca de 12 pontos log para essa coorte. A comparação pede cuidado. Os autores analisam estoque de emprego em firmas e comparam quintis de exposição, enquanto esta dissertação observa fluxos mensais por ocupação e usa uma classificação binária mais ampla. Aqui, o contraste ajustado aparece na faixa de 41 a 49 anos e tem sinal positivo.",
  "section": "5.2.3 Resultados por faixa etária",
  "paragraph": "9"
}
```
...
Technical identity:
- row_id: `ROW-CUR-0195`
- claim_row_sha256: `4c08b20926ebc7c89cea5e2a2baa2178732905defb7979322599110d3ac6b65d`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0195.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0195.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0195`
- `claim_id`: `CLM-CUR-157`
- `occurrence_id`: `CIT-CUR-052`
- `worker_task_name`: `current_claim_row_0195`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0195.pdf`
