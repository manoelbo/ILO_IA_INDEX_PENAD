# Isolated current claim audit: ROW-CUR-0055
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0055`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0055.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0055.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0055/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O ILO Global Index é apresentado como o único índice estruturado na ISCO-08.",
...
Technical identity:
- row_id: `ROW-CUR-0055`
- claim_row_sha256: `3ebe5be618eb309864a1e775196f079ba808ef0f6d344dbe71e125a4a27d7717`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0055.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0055.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0055`
- `claim_id`: `CLM-CUR-045`
- `occurrence_id`: `CIT-CUR-013`
- `worker_task_name`: `current_claim_row_0055`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0055.pdf`
