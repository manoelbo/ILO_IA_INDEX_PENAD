# Isolated current claim audit: ROW-CUR-0089
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0089`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0089.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0089.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0089/`
...
{
  "row_id": "ROW-CUR-0089",
  "claim_id": "CLM-CUR-079",
  "occurrence_id": "CIT-CUR-017",
  "citation_key": "appel_anthropic_2026",
  "work": "Anthropic Economic Index report: Economic primitives",
  "claim_type": "DIRECT",
  "affirmation_pt": "O Anthropic Economic Index apresenta viés de amostragem por observar apenas usuários de modelos específicos.",
...
Technical identity:
- row_id: `ROW-CUR-0089`
- claim_row_sha256: `b199b613b45caefa49586c4f277f20ec398c761d0a5b9518b95427b81e9b8d81`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0089.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0089.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0089`
- `claim_id`: `CLM-CUR-079`
- `occurrence_id`: `CIT-CUR-017`
- `worker_task_name`: `current_claim_row_0089`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0089.pdf`
