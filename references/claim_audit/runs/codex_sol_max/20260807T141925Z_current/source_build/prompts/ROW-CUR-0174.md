# Isolated current claim audit: ROW-CUR-0174
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0174`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0174.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0174.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0174/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Klein Teeselink (2025) documenta reduções de emprego no Reino Unido.",
...
Technical identity:
- row_id: `ROW-CUR-0174`
- claim_row_sha256: `5793905da12125b99337df8282b0e598e892fb6b2c83da2e9b32087a9bae8edb`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0174.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0174.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0174`
- `claim_id`: `CLM-CUR-144`
- `occurrence_id`: `CIT-CUR-045`
- `worker_task_name`: `current_claim_row_0174`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0174.pdf`
