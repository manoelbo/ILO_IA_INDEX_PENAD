# Isolated current claim audit: ROW-CUR-0067
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0067`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0067.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0067.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0067/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O GPT Exposure utiliza a taxonomia ocupacional americana O*NET/SOC.",
...
Technical identity:
- row_id: `ROW-CUR-0067`
- claim_row_sha256: `1fea6c3bac5efc7b31e7c1e1ace928669fdd6c63f987d00f7b521ee14ec84248`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0067.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0067.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0067`
- `claim_id`: `CLM-CUR-057`
- `occurrence_id`: `CIT-CUR-015`
- `worker_task_name`: `current_claim_row_0067`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0067.pdf`
