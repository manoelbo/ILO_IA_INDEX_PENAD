# Isolated current claim audit: ROW-CUR-0160
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0160`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0160.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0160.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0160/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Teutloff et al. (2025) adotam o mesmo procedimento de placebo temporal estimado apenas no verdadeiro período anterior ao evento, com descarte do período posterior.",
...
Technical identity:
- row_id: `ROW-CUR-0160`
- claim_row_sha256: `9e1e2373d845214d8d2f3659bf02b810585d0fa0b7850b78c01c0699ca23825c`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0160.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0160.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0160`
- `claim_id`: `CLM-CUR-130`
- `occurrence_id`: `CIT-CUR-039`
- `worker_task_name`: `current_claim_row_0160`
...
- `source_sha256`: `a64350970c9252167ef65c3fa693d47c8e5eb84c4ae22841f8c2006db0d24802`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0160.pdf`
