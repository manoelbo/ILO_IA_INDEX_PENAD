# Isolated current claim audit: ROW-CUR-0170
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0170`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0170.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0170.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0170/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Humlum e Vestergaard (2025) reportam efeitos nulos e precisos sobre horas trabalhadas na Dinamarca.",
...
Technical identity:
- row_id: `ROW-CUR-0170`
- claim_row_sha256: `3355a96042f983e08313cb88dff9de1ee9a5368df68e53b6b8f35813c9f32873`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0170.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0170.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0170`
- `claim_id`: `CLM-CUR-140`
- `occurrence_id`: `CIT-CUR-042`
- `worker_task_name`: `current_claim_row_0170`
...
- `source_sha256`: `eb5765a77d38f7e0d66e906252ecb721aaa888f6ba3540913e3cb31edcb91807`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0170.pdf`
