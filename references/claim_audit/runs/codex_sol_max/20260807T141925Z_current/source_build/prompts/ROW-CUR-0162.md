# Isolated current claim audit: ROW-CUR-0162
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0162`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0162.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0162.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0162/`
...
{
  "row_id": "ROW-CUR-0162",
  "claim_id": "CLM-CUR-132",
  "occurrence_id": "CIT-CUR-040",
  "citation_key": "rambachan_more_2023",
  "work": "A More Credible Approach to Parallel Trends",
  "claim_type": "DIRECT",
  "affirmation_pt": "O procedimento de Rambachan e Roth (2023) estima quanto as tendências anteriores ao evento poderiam divergir sem alterar a conclusão.",
...
Technical identity:
- row_id: `ROW-CUR-0162`
- claim_row_sha256: `ebe21a9c70714b44aa56a6d236e871d09eea12bf2eddcf4cf98a955a005c3e51`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0162.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0162.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0162`
- `claim_id`: `CLM-CUR-132`
- `occurrence_id`: `CIT-CUR-040`
- `worker_task_name`: `current_claim_row_0162`
...
- `source_sha256`: `2ef3448e51bb946478ad323b8e00fc5de80fcc1b274ec26aa01dfaa9e458b7dc`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0162.pdf`
