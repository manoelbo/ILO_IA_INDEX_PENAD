# Isolated current claim audit: ROW-CUR-0094
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0094`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0094.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0094.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0094/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A classificação validada do ILO Global Index é escalada por modelos de linguagem.",
...
Technical identity:
- row_id: `ROW-CUR-0094`
- claim_row_sha256: `1f0ca257357805f36f82d6c1d5a3f60b0484a66b5e5e305488806730ec806410`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0094.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0094.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0094`
- `claim_id`: `CLM-CUR-084`
- `occurrence_id`: `CIT-CUR-018`
- `worker_task_name`: `current_claim_row_0094`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0094.pdf`
