# Isolated current claim audit: ROW-CUR-0205
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0205`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0205.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0205.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0205/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) testam se a taxonomia de exposição previa emprego antes da difusão dos modelos de linguagem, inclusive durante o pico de desemprego da pandemia.",
...
Technical identity:
- row_id: `ROW-CUR-0205`
- claim_row_sha256: `067389769b66b4145d9e84fca0ff709e81ca0a60704b7c135b1f8397ac7a3a09`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0205.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0205.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0205`
- `claim_id`: `CLM-CUR-167`
- `occurrence_id`: `CIT-CUR-058`
- `worker_task_name`: `current_claim_row_0205`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0205.pdf`
