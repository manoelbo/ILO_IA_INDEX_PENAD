# Isolated current claim audit: ROW-CUR-0064
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0064`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0064.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0064.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0064/`
...
```json
{
  ...
  "affirmation_pt": "No ILO Global Index, o desvio-padrão mede a dispersão da exposição entre as tarefas da ocupação.",
...
Technical identity:
- row_id: `ROW-CUR-0064`
- claim_row_sha256: `a417944686a6a1a7b578e6b669bb7acff903eef14e8e6c0c57485052abb6421c`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0064.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0064.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0064`
- `claim_id`: `CLM-CUR-054`
- `occurrence_id`: `CIT-CUR-013`
- `worker_task_name`: `current_claim_row_0064`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0064.pdf`
