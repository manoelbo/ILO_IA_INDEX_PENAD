# Isolated current claim audit: ROW-CUR-0190
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0190`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0190.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0190.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0190/`
...
{
  "row_id": "ROW-CUR-0190",
  "claim_id": "CLM-CUR-152",
  "occurrence_id": "CIT-CUR-051",
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) adotam a classificação etária reproduzida nos painéis adicionais do apêndice da dissertação.",
  "source_excerpt": "A Tabela 5.2.3 traz as estimativas por faixa etária, nas faixas da PNAD/IBGE. Os contrastes DDD e os painéis da classificação etária adotada por Brynjolfsson, Chandar e Chen (2025) são apresentados no Apêndice A.",
...
Technical identity:
- row_id: `ROW-CUR-0190`
- claim_row_sha256: `89656aea559205ea7aeb52488e5837b5f9ea4333f4a807382ca32e94959dbaf9`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0190.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0190.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0190`
- `claim_id`: `CLM-CUR-152`
- `occurrence_id`: `CIT-CUR-051`
- `worker_task_name`: `current_claim_row_0190`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0190.pdf`
