# Isolated current claim audit: ROW-CUR-0072
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0072`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0072.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0072.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0072/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A validação humana inicial é apresentada como uma vantagem do GPT Exposure.",
...
Technical identity:
- row_id: `ROW-CUR-0072`
- claim_row_sha256: `5dea0176939686b2076d8634bf702646e9eb2c6449257a6e9c4df8c0313a9021`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0072.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0072.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0072`
- `claim_id`: `CLM-CUR-062`
- `occurrence_id`: `CIT-CUR-015`
- `worker_task_name`: `current_claim_row_0072`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0072.pdf`
