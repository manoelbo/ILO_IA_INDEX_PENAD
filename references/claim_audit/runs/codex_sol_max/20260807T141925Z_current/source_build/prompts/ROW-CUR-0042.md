# Isolated current claim audit: ROW-CUR-0042
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0042`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0042.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0042.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0042/`
...
{
  "row_id": "ROW-CUR-0042",
  "claim_id": "CLM-CUR-032",
  "occurrence_id": "CIT-CUR-010",
  ...
  "affirmation_pt": "O critério do GPT Exposure perguntava se a IA reduziria em pelo menos 50% o tempo de uma tarefa mantendo a mesma qualidade.",
...
Technical identity:
- row_id: `ROW-CUR-0042`
- claim_row_sha256: `67073cb655dadeca24b2417722cc387eac747778525d87b574607623df7aa125`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0042.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0042.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0042`
- `claim_id`: `CLM-CUR-032`
- `occurrence_id`: `CIT-CUR-010`
- `worker_task_name`: `current_claim_row_0042`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0042.pdf`
