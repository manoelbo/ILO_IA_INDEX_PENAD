# Isolated current claim audit: ROW-CUR-0171
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0171`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0171.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0171.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0171/`
...
{
  "row_id": "ROW-CUR-0171",
  "claim_id": "CLM-CUR-141",
  "occurrence_id": "CIT-CUR-043",
  "citation_key": "chandar_tracking_2025",
  "work": "Tracking employment changes in AI-exposed jobs",
  "claim_type": "DIRECT",
  "affirmation_pt": "Chandar (2025) não identifica diferenças sistemáticas entre ocupações expostas e não expostas na Current Population Survey.",
...
Technical identity:
- row_id: `ROW-CUR-0171`
- claim_row_sha256: `9194729db5439364a1a06be33eb4134639979e181de9d0248e51eeb30b02cc82`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0171.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0171.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0171`
- `claim_id`: `CLM-CUR-141`
- `occurrence_id`: `CIT-CUR-043`
- `worker_task_name`: `current_claim_row_0171`
...
- `source_sha256`: `43b8b1867d44fec8e557eea0001f73db5394ab2a05cef2bafbf2d74d3c9c9eba`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0171.pdf`
