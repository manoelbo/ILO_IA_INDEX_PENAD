# Isolated current claim audit: ROW-CUR-0105
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0105`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0105.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0105.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0105/`
...
{
  "row_id": "ROW-CUR-0105",
  "claim_id": "CLM-CUR-095",
  "occurrence_id": "CIT-CUR-021",
  "citation_key": "gmyrek_generative_2025",
  "work": "Generative AI and jobs: A refined global index of occupational exposure",
  "claim_type": "DIRECT",
  "affirmation_pt": "A fonte declarada para a base é a combinação da PNAD Contínua do terceiro trimestre de 2025 com o ILO Working Paper 140.",
  "source_excerpt": "PNADc 3T/2025 (IBGE) + ILO WP140 (Gmyrek et al., 2025)",
...
Technical identity:
- row_id: `ROW-CUR-0105`
- claim_row_sha256: `1adccfe3bf093076266bf1c47e32db3046bde5801f6e3732d9123ca1fdef8b30`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0105.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0105.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0105`
- `claim_id`: `CLM-CUR-095`
- `occurrence_id`: `CIT-CUR-021`
- `worker_task_name`: `current_claim_row_0105`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0105.pdf`
