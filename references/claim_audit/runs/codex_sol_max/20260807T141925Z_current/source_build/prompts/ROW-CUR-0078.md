# Isolated current claim audit: ROW-CUR-0078
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0078`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0078.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0078.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0078/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O GENOE realiza uma avaliação holística da ocupação.",
...
Technical identity:
- row_id: `ROW-CUR-0078`
- claim_row_sha256: `f8b3aa0963c9d2b68196cb27c902bf4f5dc18e4bccb075e9a1d2fbb960737b9e`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0078.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0078.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0078`
- `claim_id`: `CLM-CUR-068`
- `occurrence_id`: `CIT-CUR-016`
- `worker_task_name`: `current_claim_row_0078`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0078.pdf`
