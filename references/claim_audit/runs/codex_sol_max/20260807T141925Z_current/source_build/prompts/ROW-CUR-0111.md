# Isolated current claim audit: ROW-CUR-0111
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0111`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0111.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0111.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0111/`
...
{
  "row_id": "ROW-CUR-0111",
  "claim_id": "CLM-CUR-101",
  "occurrence_id": "CIT-CUR-025",
  ...
  "affirmation_pt": "A ADP processa a folha de pagamento de mais de 25 milhões de trabalhadores nos Estados Unidos.",
  "source_excerpt": "A principal referência para a estratégia empírica é o estudo de Brynjolfsson, Chandar e Chen (2025). Os autores usam registros mensais da ADP, que processa a folha de mais de 25 milhões de trabalhadores nos Estados Unidos.",
...
Technical identity:
- row_id: `ROW-CUR-0111`
- claim_row_sha256: `7062345e5b84709bb7653fbd440635f821d189fde2f9db764de7cc4f9aa00b18`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0111.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0111.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0111`
- `claim_id`: `CLM-CUR-101`
- `occurrence_id`: `CIT-CUR-025`
- `worker_task_name`: `current_claim_row_0111`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0111.pdf`
