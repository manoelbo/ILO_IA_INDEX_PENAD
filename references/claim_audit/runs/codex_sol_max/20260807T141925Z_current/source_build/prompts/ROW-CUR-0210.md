# Isolated current claim audit: ROW-CUR-0210
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0210`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0210.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0210.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0210/`
...
```json
{
  ...
  "affirmation_pt": "Nos casos brasileiros, há uma trajetória compatível com o padrão de entrada do artigo em atendimento ao cliente, mas não em software.",
...
Technical identity:
- row_id: `ROW-CUR-0210`
- claim_row_sha256: `d04d62245ff1364d6a86b9521a7c4a10d2e2c86fc0a42079c12db4d1ce6a9307`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0210.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0210.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0210`
- `claim_id`: `CLM-CUR-172`
- `occurrence_id`: `CIT-CUR-059`
- `worker_task_name`: `current_claim_row_0210`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0210.pdf`
