# Isolated current claim audit: ROW-CUR-0166
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0166`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0166.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0166.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0166/`
...
{
  "row_id": "ROW-CUR-0166",
  "claim_id": "CLM-CUR-136",
  "occurrence_id": "CIT-CUR-041",
  ...
  "affirmation_pt": "Os autores testam explicitamente se a taxonomia de exposição previa resultados de emprego antes da difusão dos modelos de linguagem, inclusive durante o pico de desemprego da pandemia de Covid-19.",
  "source_excerpt": "Brynjolfsson, Chandar e Chen (2025), principal referência desta seção, não encontram diferenças significativas de emprego entre ocupações mais e menos expostas fora da faixa de 22 a 25 anos e, ao contrário do que ocorre aqui, não enfrentam o problema de tendências prévias: os autores testam explicitamente se a taxonomia de exposição previa resultados de emprego antes da difusão dos modelos de linguagem — inclusive durante o pico de desemprego da pandemia de Covid-19 — e relatam que não previa, o que os leva a datar os padrões observados no fim de 2022 e início de 2023.",
...
Technical identity:
- row_id: `ROW-CUR-0166`
- claim_row_sha256: `37e34dc8759bcf44bca0cb420422d0481787170791c11acce8f70f6e0200b71e`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0166.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0166.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0166`
- `claim_id`: `CLM-CUR-136`
- `occurrence_id`: `CIT-CUR-041`
- `worker_task_name`: `current_claim_row_0166`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0166.pdf`
