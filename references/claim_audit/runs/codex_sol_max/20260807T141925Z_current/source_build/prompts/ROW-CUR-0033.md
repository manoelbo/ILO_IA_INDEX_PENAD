# Isolated current claim audit: ROW-CUR-0033
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0033`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0033.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0033.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0033/`
...
```json
{
  ...
  "affirmation_pt": "Automatizar a tarefa de diagnóstico não torna o radiologista inteiramente substituível, porque automatiza apenas uma parte do trabalho.",
...
Technical identity:
- row_id: `ROW-CUR-0033`
- claim_row_sha256: `dc6a01d84ef57f3f6951fdd205d40acc736fe4018b58cfee6fafc9969611d49f`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0033.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0033.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0033`
- `claim_id`: `CLM-CUR-023`
- `occurrence_id`: `CIT-CUR-009`
- `worker_task_name`: `current_claim_row_0033`
...
- `source_sha256`: `7e3c307db768df2d4e4d1b31247229e75fb3e819015ff3d7344539edd7600e74`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0033.pdf`
