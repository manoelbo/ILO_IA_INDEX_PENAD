# Isolated current claim audit: ROW-CUR-0120
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0120`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0120.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0120.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0120/`
...
{
  "row_id": "ROW-CUR-0120",
  "claim_id": "CLM-CUR-110",
  "occurrence_id": "CIT-CUR-028",
  "citation_key": "humlum_still_2025",
  "work": "Still waters, rapid currents: Early labor market transformation under generative AI",
  "claim_type": "DIRECT",
  "affirmation_pt": "Estudos de evento centrados em novembro de 2022 são apresentados como prática comum na literatura.",
  "source_excerpt": "A escolha também segue uma prática comum na literatura: Humlum e Vestergaard (2025, p. 12, nota 8) identificam cinco estudos de evento centrados em novembro de 2022.",
...
Technical identity:
- row_id: `ROW-CUR-0120`
- claim_row_sha256: `e28190c44a6cdcffccb89867cd002774bbfa22b6ab2717ce2452c561e2d44dc5`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0120.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0120.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0120`
- `claim_id`: `CLM-CUR-110`
- `occurrence_id`: `CIT-CUR-028`
- `worker_task_name`: `current_claim_row_0120`
...
- `source_sha256`: `eb5765a77d38f7e0d66e906252ecb721aaa888f6ba3540913e3cb31edcb91807`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0120.pdf`
