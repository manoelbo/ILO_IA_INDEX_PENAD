# Isolated current claim audit: ROW-CUR-0087
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0087`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0087.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0087.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0087/`
...
{
  "row_id": "ROW-CUR-0087",
  "claim_id": "CLM-CUR-077",
  "occurrence_id": "CIT-CUR-017",
  "citation_key": "appel_anthropic_2026",
  "work": "Anthropic Economic Index report: Economic primitives",
  "claim_type": "DIRECT",
  "affirmation_pt": "O Anthropic Economic Index classifica o uso por dimensões de autonomia e taxa de sucesso.",
...
Technical identity:
- row_id: `ROW-CUR-0087`
- claim_row_sha256: `a7edf2fa81ea18a93562606573e5edd6f2a8266109f34adeb0deac158e773eb9`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0087.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0087.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0087`
- `claim_id`: `CLM-CUR-077`
- `occurrence_id`: `CIT-CUR-017`
- `worker_task_name`: `current_claim_row_0087`
...
- `source_sha256`: `456274578d26ae653c43eabf560dd8b9018130f2a6ac10a921689a57d7c76d9a`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0087.pdf`
