# Isolated current claim audit: ROW-CUR-0083
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0083`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0083.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0083.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0083/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A base ocupacional do GENOE é americana.",
...
Technical identity:
- row_id: `ROW-CUR-0083`
- claim_row_sha256: `ec1680db6a44936cfc51ebc9b05fb3880b7291de455b51b2af2c69ec75a3a6ce`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0083.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0083.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0083`
- `claim_id`: `CLM-CUR-073`
- `occurrence_id`: `CIT-CUR-016`
- `worker_task_name`: `current_claim_row_0083`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0083.pdf`
