# Isolated current claim audit: ROW-CUR-0096
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0096`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0096.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0096.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0096/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "A validação em múltiplas etapas é apresentada como uma vantagem do ILO Global Index.",
...
Technical identity:
- row_id: `ROW-CUR-0096`
- claim_row_sha256: `1bdea74c5af68cce58e26197cdc1eba57092699d76b69dca75c764b4a5724006`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0096.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0096.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0096`
- `claim_id`: `CLM-CUR-086`
- `occurrence_id`: `CIT-CUR-018`
- `worker_task_name`: `current_claim_row_0096`
...
- `source_sha256`: `9077761c72aabaa3c7ee70999ec5aa46a6afcf943b5fb01baa971f601d363ee9`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0096.pdf`
