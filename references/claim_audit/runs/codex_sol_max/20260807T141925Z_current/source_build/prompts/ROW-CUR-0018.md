# Isolated current claim audit: ROW-CUR-0018
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0018`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0018.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0018.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0018/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O ajuste documentado por esses estudos concentra-se no emprego, e não na remuneração.",
...
Technical identity:
- row_id: `ROW-CUR-0018`
- claim_row_sha256: `b49466d9ef152acde3c472488e644bb04ac530ed0f4894bbe5ab54ed517c9a1f`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0018.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0018.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0018`
- `claim_id`: `CLM-CUR-010`
- `occurrence_id`: `CIT-CUR-005`
- `worker_task_name`: `current_claim_row_0018`
...
- `source_sha256`: `869c82402a2aa0636723ff72109b970bc2e6579c08ea43240207054818c93d09`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0018.pdf`
