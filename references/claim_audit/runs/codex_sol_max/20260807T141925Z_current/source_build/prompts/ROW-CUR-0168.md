# Isolated current claim audit: ROW-CUR-0168
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0168`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0168.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0168.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0168/`
...
```json
{
  ...
  "affirmation_pt": "A ausência de previsão prévia leva os autores a datar os padrões observados no fim de 2022 e no início de 2023.",
...
Technical identity:
- row_id: `ROW-CUR-0168`
- claim_row_sha256: `133afcc6bb2975b860733523d46e55473fc38e3b621591b4613b6f07b44e5bdf`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0168.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0168.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0168`
- `claim_id`: `CLM-CUR-138`
- `occurrence_id`: `CIT-CUR-041`
- `worker_task_name`: `current_claim_row_0168`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0168.pdf`
