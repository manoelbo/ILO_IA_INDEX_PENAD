# Isolated current claim audit: ROW-CUR-0047
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0047`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0047.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0047.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0047/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "O uso do contexto completo da ocupação permite ao GENOE realizar uma avaliação mais holística.",
...
Technical identity:
- row_id: `ROW-CUR-0047`
- claim_row_sha256: `975b399a43b5bafac216e5bab8db083e526049f448706d8a23a189f458ec6a7f`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0047.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0047.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0047`
- `claim_id`: `CLM-CUR-037`
- `occurrence_id`: `CIT-CUR-011`
- `worker_task_name`: `current_claim_row_0047`
...
- `source_sha256`: `8847920fa160282c8ba5b5f456f35b24669a7e19dd8a655e2a801b265efb5fda`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0047.pdf`
