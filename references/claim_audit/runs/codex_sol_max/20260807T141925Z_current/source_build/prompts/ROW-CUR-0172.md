# Isolated current claim audit: ROW-CUR-0172
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0172`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0172.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0172.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0172/`
...
```json
{
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Em firmas adotantes, Hosseini Maasoum e Lichtinger (2025) documentam desaceleração das contratações.",
...
Technical identity:
- row_id: `ROW-CUR-0172`
- claim_row_sha256: `033c4aa347e727eb61e5661bd0f6e54cbdf52b8e902df24850a2dd5fe1738490`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0172.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0172.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0172`
- `claim_id`: `CLM-CUR-142`
- `occurrence_id`: `CIT-CUR-044`
- `worker_task_name`: `current_claim_row_0172`
...
- `source_sha256`: `31acdd45ede51eed44b58cf43c555c9f318cc8b0c3889d177efac291490286e7`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0172.pdf`
