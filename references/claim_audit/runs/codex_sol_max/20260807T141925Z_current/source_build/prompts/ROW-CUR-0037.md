# Isolated current claim audit: ROW-CUR-0037
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0037`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0037.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0037.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0037/`
...
```json
{
  ...
  "affirmation_pt": "O GPT Exposure foi o primeiro índice a usar a própria IA para avaliar tarefas.",
...
Technical identity:
- row_id: `ROW-CUR-0037`
- claim_row_sha256: `4accc617f39513b0722cbef868fa74499c6889fc662cb8b0fc2adf6ac5575c8c`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0037.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0037.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0037`
- `claim_id`: `CLM-CUR-027`
- `occurrence_id`: `CIT-CUR-010`
- `worker_task_name`: `current_claim_row_0037`
...
- `source_sha256`: `af3edd4efc120c70f0e2e6dc7a4e314a41f1b9eb5a7e88bc25533db631f79632`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0037.pdf`
