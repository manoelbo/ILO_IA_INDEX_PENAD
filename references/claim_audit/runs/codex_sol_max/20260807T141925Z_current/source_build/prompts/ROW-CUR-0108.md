# Isolated current claim audit: ROW-CUR-0108
...
- Fallback: prohibited
- Worker task name: `current_claim_row_0108`
...
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/candidates/ROW-CUR-0108.candidate.json`
- `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/evidence_pages/ROW-CUR-0108.pdf`
- optional visual renders under `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/renders/ROW-CUR-0108/`
...
{
  "row_id": "ROW-CUR-0108",
  "claim_id": "CLM-CUR-098",
  "occurrence_id": "CIT-CUR-024",
  ...
  "claim_type": "DIRECT",
  "affirmation_pt": "Brynjolfsson, Chandar e Chen (2025) documentam, nos Estados Unidos, efeitos diferenciados após o lançamento do ChatGPT para a coorte jovem mais exposta.",
  "source_excerpt": "A exposição decresce de forma monotônica com a idade, partindo de 0,304 na faixa de 18 a 24 anos e caindo até 0,252 na faixa de 55 a 59 anos, uma diferença de 0,056 ponto, equivalente a +22% para os mais jovens em relação aos mais velhos. O contraste é ainda mais expressivo no segmento de alta exposição: a faixa de 18 a 24 anos tem 3,2 vezes mais trabalhadores em alta exposição (16,2%) do que a de 55+ (5,9%). Os jovens estão mais expostos por uma razão estrutural: ingressam preferencialmente em ocupações de apoio administrativo, vendas e serviços qualificados, justamente as mais expostas. Esse achado tem peso analítico relevante na segunda etapa desta dissertação, em que avalio se essa coorte mais exposta sofreu efeitos diferenciados após o lançamento do ChatGPT, padrão já documentado por Brynjolfsson, Chandar e Chen (2025) nos Estados Unidos.",
  "section": "3.5.3 Análise por faixa etária",
  "paragraph": "2"
}
```
...
Technical identity:
- row_id: `ROW-CUR-0108`
- claim_row_sha256: `fbdb242cb0e3b87b671d37ff1c8c68def4e88210e6c0aac21d01dd2c920a02f1`
...
Compute `/Users/manebrasil/Documents/Projects/Dissetação Mestrado/references/claim_audit/runs/codex_sol_max/20260807T141925Z_current/source_build/prompts/ROW-CUR-0108.md`'s SHA-256 after reading it and store it as `worker_prompt_sha256`.
...
Write one JSON object conforming exactly to `claim_result.schema.json` at `source_build/candidates/ROW-CUR-0108.candidate.json`. Use:
- `schema_version`: `1.0.0`
- `row_id`: `ROW-CUR-0108`
- `claim_id`: `CLM-CUR-098`
- `occurrence_id`: `CIT-CUR-024`
- `worker_task_name`: `current_claim_row_0108`
...
- `source_sha256`: `3b342bf604ed5c8fad8a232c9879345bcb7b71583f33d2acead28d531467a188`
- `schema_sha256`: `85f16224d232713ba83d6450158df801d1c2df99439e391f80a59b0d4a91ac15`
- `evidence_path`: `evidence_pages/ROW-CUR-0108.pdf`
