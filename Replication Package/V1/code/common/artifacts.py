...
def write_artifact_navigation(
    ...
    lines = [
        "# Índice de artefatos reproduzidos",
        "",
        "[Manifest de artefatos](artifact_manifest.csv) · "
        "[Validação](validation/validation_checks.md) · "
        "[Manifest da execução](run_manifest.json)",
        "",
