...
def write_run_manifest(
    *,
    ...
    if section != "3":
        raise ValueError(f"Unsupported component manifest section: {section}")
    input_records = [
        {
    ...
    code_files = [
        ...
        for path in [
            ...
            package_root / "renv.lock",
            package_root / "R" / "section3_replication.R",
            *[
                source
