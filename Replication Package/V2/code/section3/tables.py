"""Build four manuscript tables and the demographic backing table."""
...
def write_tables(
    ...
    *,
    ...
    demographics = build_demographics(frame)
    backing_csv = (
        output_dir / "backing_data" / "table_3_5_demographics_summary.csv"
    )
    backing_csv.parent.mkdir(parents=True, exist_ok=True)
    demographics.to_csv(backing_csv, index=False, lineterminator="\n")
    return written
